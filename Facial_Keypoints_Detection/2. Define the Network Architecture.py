...
# 
# 
# ### TODODefine your model in the provided file `models.py` file
# 
...
for j in range(4):
    sample = transformed_dataset[j]
    print(j, sample['image'].size(), sample['keypoints'])
...
for i, sample in enumerate(test_loader):
    ...
    images = cv2.filter2D(images,-1,kernel)
